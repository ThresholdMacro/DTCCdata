...
The number of swaptions contracts traded in March was `r nrow(swaptions)` representing `r round(nrow(swaptions)/nrow(data)*100,2)` of all the trades reported to DTCC.
